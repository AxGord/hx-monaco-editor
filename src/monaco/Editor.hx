...
typedef MonacoWebWorker<T> = {
	function dispose():Void;
	function getProxy():js.Promise<T>;
	function withSyncedResources(resources:Array<Uri>):js.Promise<T>;
};
...
extern class Editor {
	...
	function colorizeElement(domNode:js.html.Element, options:IColorizerElementOptions):js.Promise<Void>;
	function colorize(text:String, languageId:String, options:IColorizerOptions):js.Promise<String>;
